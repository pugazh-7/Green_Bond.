...
import {
    ...
    login as canonicalLogin,
    validateToken as canonicalValidateToken,
    updateLocation as canonicalUpdateLocation,
    logout as canonicalLogout
...
// Canonical Register Endpoints (User, Customer, Unified)
router.post('/register', canonicalRegister);
router.post('/register-user', canonicalRegister);
...
// Canonical Login Endpoints (User, Customer, Unified)
router.post('/login', canonicalLogin);
router.post('/login-user', canonicalLogin);
...
router.post('/logout', canonicalLogout);

// Validate Token
router.get('/validate-token', verifyToken, canonicalValidateToken);

// Update Location for Authenticated Account (User, Farmer, Delivery Partner, Shop)
router.put('/update-location', verifyToken, canonicalUpdateLocation);
