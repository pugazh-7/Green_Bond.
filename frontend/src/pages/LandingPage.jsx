        ...
        <div className="flex flex-col">
            ...
            <section className="relative h-[600px] flex items-center justify-center bg-gradient-to-br from-green-950 via-green-800 to-teal-950 overflow-hidden">
                ...
                <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-16 relative z-10 text-center">
                    <h1 className="text-4xl md:text-5xl 2xl:text-6xl font-extrabold text-white mb-6 2xl:mb-8 leading-tight drop-shadow-2xl">
                        Empowering Farmers, <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-teal-300">Connecting Futures</span>
                    </h1>
                    <p className="text-lg md:text-xl 2xl:text-2xl text-gray-200 mb-8 2xl:mb-10 max-w-2xl 2xl:max-w-4xl mx-auto drop-shadow-lg">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link to="/signup/user" className="px-6 py-3 2xl:px-10 2xl:py-5 bg-gradient-to-r from-green-600 to-green-500 text-white font-bold rounded-xl shadow-lg hover:shadow-green-500/30 hover:scale-105 transform transition-all text-base 2xl:text-xl flex items-center justify-center gap-2 border border-green-400/20">
                            Join as User
                        </Link>
                        <Link to="/signup/farmer" className="px-6 py-3 2xl:px-10 2xl:py-5 bg-gradient-to-r from-teal-600 to-teal-500 text-white font-bold rounded-xl shadow-lg hover:shadow-teal-500/30 hover:scale-105 transform transition-all text-base 2xl:text-xl flex items-center justify-center gap-2 border border-teal-400/20">
                            <span>Join as Farmer</span>
                        </Link>
                    </div>
                    <div className="mt-8 2xl:mt-10 flex gap-6 2xl:gap-10 justify-center text-xs 2xl:text-base font-medium text-gray-400">
            ...
            <section className="py-20 bg-white">
                <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-16 text-center">
                    <h2 className="text-2xl 2xl:text-4xl font-bold text-gray-900 mb-6 2xl:mb-10">About GreenBond</h2>
                    <p className="text-base 2xl:text-xl text-gray-600 max-w-4xl 2xl:max-w-5xl mx-auto leading-relaxed">
            ...
            <section id="objectives" className="py-20 bg-gradient-to-b from-gray-50 to-green-50/30">
                <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-16">
                    <h2 className="text-2xl 2xl:text-4xl font-bold text-gray-900 mb-8 2xl:mb-12 text-center">Our Objectives</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={index} className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100">
                                <h3 className="text-lg 2xl:text-xl font-bold text-green-700 mb-3 2xl:mb-5">{item.title}</h3>
                                <p className="text-gray-600 text-sm 2xl:text-base">{item.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section id="solution" className="py-20 bg-white">
                <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-16">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-2xl 2xl:text-4xl font-bold text-gray-900 mb-6 2xl:mb-8">The Problem</h2>
                            <p className="text-base 2xl:text-lg text-gray-600 mb-8 2xl:mb-10">
                            ...
                            <h2 className="text-2xl 2xl:text-4xl font-bold text-gray-900 mb-6 2xl:mb-8">Our Solution</h2>
                            <p className="text-base 2xl:text-lg text-gray-600">
            ...
            <section className="py-24 bg-gradient-to-br from-green-900 to-teal-900 text-white relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    <h2 className="text-2xl md:text-3xl 2xl:text-5xl font-bold mb-6 2xl:mb-8">Sustainability Impact</h2>
                    <p className="text-lg 2xl:text-2xl text-green-100 max-w-3xl 2xl:max-w-4xl mx-auto leading-relaxed">
