        ...
        <div className="flex flex-col">
            ...
            <section className="relative h-[600px] flex items-center justify-center bg-gradient-to-br from-green-950 via-green-800 to-teal-950 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link to="/signup/user" className="px-8 py-4 bg-gradient-to-r from-green-600 to-green-500 text-white font-bold rounded-xl shadow-lg hover:shadow-green-500/30 hover:scale-105 transform transition-all text-lg flex items-center justify-center gap-2 border border-green-400/20">
                            Join as User
                        </Link>
                        <Link to="/signup/farmer" className="px-8 py-4 bg-gradient-to-r from-teal-600 to-teal-500 text-white font-bold rounded-xl shadow-lg hover:shadow-teal-500/30 hover:scale-105 transform transition-all text-lg flex items-center justify-center gap-2 border border-teal-400/20">
                            <span>Join as Farmer</span>
                        </Link>
                    </div>
                    <div className="mt-8 flex gap-6 justify-center text-sm font-medium text-gray-400">
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl font-bold text-gray-900 mb-8">About GreenBond</h2>
            ...
            <section id="objectives" className="py-20 bg-gradient-to-b from-gray-50 to-green-50/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">Our Objectives</h2>
