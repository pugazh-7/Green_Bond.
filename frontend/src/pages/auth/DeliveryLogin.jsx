...
const DeliveryLogin = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await apiFetch('/api/auth/login-delivery', {
                method: 'POST',
            ...
            if (response.ok && (data.partner || data.user)) {
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 w-full">
                ...
                <div className="mt-8 text-center border-t border-gray-100 pt-6">
                    <p className="text-sm text-gray-600">
                        ...
                        <Link to="/signup/delivery" id="account-create-delivery" className="font-bold text-blue-600 hover:text-blue-800 transition-colors">
                            Create account
                        </Link>
                    </p>
                </div>
