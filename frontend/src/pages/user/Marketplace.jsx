                            ...
                            return (
                                <div key={bond.id} className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col group h-full border border-gray-100">
                                    ...
                                    <div className="p-5 flex-1 flex flex-col">
                                        <h3 className="text-lg font-bold text-gray-900 mb-1 leading-tight">{bond.title}</h3>
                                        <p className="text-sm text-gray-500 mb-4">{bond.farmer}</p>
                            ...
                            <div key={item.id} className="bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col group h-full border border-gray-100">
                                ...
                                <div className="p-5 flex-1 flex flex-col">
                                    ...
                                    <div className="mt-auto flex items-center justify-between">
                                        <div>
                                            <p className="text-xs text-gray-400 font-medium">Price per {getUnit(item.price)}</p>
                                            <p className="text-2xl font-bold text-gray-900">{item.price}</p>
                                        </div>
                                        <button onClick={() => handleAction(item, 'produce')} className="px-6 py-2 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700 transition-colors shadow-green-200 shadow-lg">
                                            Buy Now
                                        </button>
                                    </div>
                                </div>
