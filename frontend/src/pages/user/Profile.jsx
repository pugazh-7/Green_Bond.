                ...
                {activeTab === 'settings' && (
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 divide-y divide-gray-100">
                        ...
                        <button 
                            ...
                            className="w-full p-4 flex items-center justify-between hover:bg-red-50 transition-colors group disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <p className="font-semibold text-red-600">{isLoggingOut ? 'Logging out...' : 'Log Out'}</p>
                            </div>
                        </button>
                    </div>
                )}
